...
type DemandeXRMFormDefaults = Pick<NewDemandeXRM, 'id' | 'updated'>;
...
type DemandeXRMFormGroupContent = {
  ...
  receptionDate: FormControl<IDemandeXRM['receptionDate']>;
  updated: FormControl<IDemandeXRM['updated']>;
...
export class DemandeXRMFormService {
  createDemandeXRMFormGroup(demandeXRM: DemandeXRMFormGroupInput = { id: null }): DemandeXRMFormGroup {
    ...
    return new FormGroup<DemandeXRMFormGroupContent>({
      ...
      receptionDate: new FormControl(demandeXRMRawValue.receptionDate),
      updated: new FormControl(demandeXRMRawValue.updated),
